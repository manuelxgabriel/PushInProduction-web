...
import { details, features } from "../constraints/index.jsx";
    ...
    <section>
      <Element name="features">
        <div className="container">
          <div
            className="relative flex md:flex-wrap flex-nonwrap border-2 border-s3
          ...
          >
            {features.map(({id, icon, caption, title, text, button}) => (
              ...
              >
                ...
                <p className="mb-11 body max-md:mb-8 mac-md-:body-3">{text}</p>
